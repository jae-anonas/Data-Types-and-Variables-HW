/**
 * Created by roosevelt on 6/20/16.
 */
/**
...
public class Main {
    public static void main(String[] args) {
        ...
        int numerator = 10;
        int divisor = 3;
        int divisionResult = numerator / divisor;   //divisionResult = 3
        System.out.println(divisionResult);

        /*
         * I know the output is 3 since if an int receives a number
         * with decimal values, it truncates the decimal value leaving
         * behind only the whole number part.
         */
